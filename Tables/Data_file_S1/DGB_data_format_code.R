...
###### Input: ../../Figure_5/data/DGB/DGB_CMap_downregulated_combined.txt: Processed expression data for DORGE-predicted OGs that are down-regulated by drug perturbations from the Connectivity Map (CMap) collection in the Drug Gene Budger (DGB) web portal.
###### Input: ../../Figure_5/data/DGB/DGB_CMap_upregulated_combined.txt: Processed expression data for DORGE-predicted TSGs that are up-regulated by drug perturbations from the Connectivity Map (CMap) collection in the Drug Gene Budger (DGB) web portal.
...
###### Output: : DGB_CMap_downregulated_formatted.txt: Formatted expression data for DORGE-predicted OGs that are down-regulated by drug perturbations from the Connectivity Map (CMap) collection in the Drug Gene Budger (DGB) web portal.
###### Output: : DGB_CMap_upregulated_formatted.txt: Formatted expression data for DORGE-predicted TSGs that are up-regulated by drug perturbations from the Connectivity Map (CMap) collection in the Drug Gene Budger (DGB) web portal.
...
data <- read.table("../../Figure_5/data/DGB/DGB_CMap_downregulated_combined.txt", header=T, sep="\t",fill=TRUE,quote = "")
colnames(data)<-c("Gene","Gene ID","Gene type","DORGE_OG_score","Drug Name","Cell_Line","Time","Dose","P-value","Q-value","Log2(fold Change)","Specificity");
write.table(data[,c("Gene","Gene ID","Gene type","Drug Name","Cell_Line","Time","Dose","P-value","Q-value","Log2(fold Change)")], "DGB_CMap_downregulated_formatted.txt",sep="\t",quote=F,row.names=F,col.names=T)

data <- read.table("../../Figure_5/data/DGB/DGB_CMap_upregulated_combined.txt", header=T, sep="\t",fill=TRUE,quote = "")
colnames(data)<-c("Gene","Gene ID","Gene type","DORGE_OG_score","Drug Name","Cell_Line","Time","Dose","P-value","Q-value","Log2(fold Change)","Specificity");
write.table(data[,c("Gene","Gene ID","Gene type","Drug Name","Cell_Line","Time","Dose","P-value","Q-value","Log2(fold Change)")], "DGB_CMap_upregulated_formatted.txt",sep="\t",quote=F,row.names=F,col.names=T)
