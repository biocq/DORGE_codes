...
public class github_prediction_driver_evaluation_on_OncoKB {

    public static void main(String[] args) throws Exception {
        String machine = "mac";

        different_approach_performance_OncoKB(machine);//Driver gene prediction evaluation based on OncoKB database - Data file S2
        
    }

    public static void different_approach_performance_OncoKB(String machine) throws Exception {
        String path = "";
        String Line = "";
        String[] temp;
        ...
        BufferedWriter bw = new BufferedWriter(new FileWriter(
                path + "Data_file_S2_OncoKB-gene_evaluation.txt"));
        Map<String, Boolean> TSG = new LinkedHashMap<String, Boolean>();
        Map<String, Boolean> CGC = new LinkedHashMap<String, Boolean>();
        ...
        while ((Line = brc.readLine()) != null) {
            ...
            if (temp[4].equals("1") && !temp[5].equals("1")) {
                CGC.put(temp[0], false);
            }
            if (temp[5].equals("1") && !temp[4].equals("1")) {
                CGC.put(temp[0], false);
            }
            if (temp[3].equals("1")) {
                NG.put(temp[0], false);
        ...
        brc = new BufferedReader(new FileReader(path + "oncoKB_cancerGeneList.tsv"));
        brc.readLine();
        ...
        brc = new BufferedReader(new FileReader(
                path+"../Table_1/q0point1/2020_driver.txt"));
        ...
        brc = new BufferedReader(new FileReader(
                path+"../Table_1/q0point1/ActiveDriver.txt"));
        while ((Line = brc.readLine()) != null) {
            //temp = Line.split("\t");
            genes.put(Line,"");
        }
        ...
        result=result+performance_different_approaches_on_cancer_driver("ActiveDriver",TSG,OG,NG,all_genes,predicted);
  			...
  			brc = new BufferedReader(new FileReader(
                path+"../Table_1/q0point1/MutPanning.txt"));
        while ((Line = brc.readLine()) != null) {
            //temp = Line.split("\t");
            genes.put(Line,"");
        }
        ...
        brc = new BufferedReader(new FileReader(
                path+"../Table_1/q0point1/MuSIC.txt"));
        while ((Line = brc.readLine()) != null) {
            //temp = Line.split("\t");
            genes.put(Line,"");
        }
        ...
        brc = new BufferedReader(new FileReader(
                path+"../Table_1/q0point1/MutSigCV.txt"));
        while ((Line = brc.readLine()) != null) {
            //temp = Line.split("\t");
            genes.put(Line,"");
        }
        ...
        brc = new BufferedReader(new FileReader(
                path+"../Table_1/q0point1/OncodriveCLUST.txt"));
        while ((Line = brc.readLine()) != null) {
            //temp = Line.split("\t");
            genes.put(Line,"");
        }
        ...
        brc = new BufferedReader(new FileReader(
                path+"../Table_1/q0point1/OncodriveFM.txt"));
        while ((Line = brc.readLine()) != null) {
            //temp = Line.split("\t");
            genes.put(Line,"");
        }
        ...
        brc = new BufferedReader(new FileReader(
                path+"../Table_1/q0point1/OncodriveFML.txt"));
        ...
        brc = new BufferedReader(new FileReader(
                path+"../Table_1/q0point1/nonredudant_GUST_driver.txt"));
        while ((Line = brc.readLine()) != null) {
            genes.put(Line,"");
        }
        brc.close();
        ...
        brc = new BufferedReader(new FileReader(
                path+"../Table_1/q0point1/TUSON_driver_reported_by_2020plus.txt"));
        while ((Line = brc.readLine()) != null) {
            //temp = Line.split("\t");
            genes.put(Line,"");
        }
