...
###### Input: BioGRID_edges_all.txt: Processed data from BioGRID v3.5.183 (Generated from folder Evaluation/BIOGRID/)
###### Input: nodes_anno.txt: Processed data from BioGRID v3.5.183 (Generated by this file, in folder Evaluation/BIOGRID/)
###### Internal: data/BioGRID/BioGRID_Cytoscape_session.cys: Cytoscape session
...
###### Input: DORGE-predicted TSG/OG lists (in data/Metascape/metascape_input_genes.xlsx)
###### Internal: MCODE_PPI.cys: Cytoscape session generated by Metascape (Original name: _FINAL_MCODE_ALL_PPIColorByCounts.pdf)
