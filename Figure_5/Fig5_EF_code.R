...
###### Output: Figure_5E_pharmacodb_network_hub_enrichment.pdf: drug-gene network hub gene enrichment in DORGE-predicted TSG/OGs, NGs and CGC genes
###### Output: Figure_5F_pharmacodb_network_hub_enrichment.pdf: drug-gene network hub gene enrichment in functional genomics gene sets (or features)
...
pdf("Raw_figures/Figure_5E_pharmacodb_network_hub_enrichment.pdf", family="ArialMT", width=4.19814*1.12, height=3.0)
...
pdf("Raw_figures/Figure_5F_pharmacodb_network_hub_enrichment.pdf", family="ArialMT", width=5.2196*1.12, height=3)
