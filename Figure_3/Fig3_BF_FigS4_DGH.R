...
###### Output: Figure_3B_ATAC_seq_evaluation.pdf: Evaluation of DORGE novel TSG/OGs by ATAC-seq data
###### Output: Figure_S4D_shRNA_evaluation.pdf: Evaluation of DORGE novel TSG/OGs by shRNA screening data
###### Output: Figure_S4G_phastcons_evaluation.pdf: Evaluation of DORGE novel TSG/OGs by phastcons feature
###### Output: Figure_3F_PhyloP_evaluation.pdf: Evaluation of DORGE novel TSG/OGs by PhyloP feature
###### Output: Figure_S4H_ncRVIS_evaluation.pdf: Evaluation of DORGE novel TSG/OGs by ncRVIS feature
...
######### Figure 3B: ATAC-seq data evaluation for DORGE prediction #########
...
pdf("Raw_figures/Figure_3B_ATAC_seq_evaluation.pdf", family="ArialMT", width=2.275, height=3)
...
######### Figure S4D: shRNA screening data evaluation for DORGE prediction #########
...
pdf("Raw_figures/Figure_S4D_shRNA_evaluation.pdf", family="ArialMT", width=2.275, height=3)
my_comparisons <- list(c("CGC-OG","CGC-TSG"),c("Novel DORGE-OG","Novel DORGE-TSG"),c("CGC-TSG","NG"),c("Novel DORGE-OG","NG"),c("CGC-OG","NG"),c("Novel DORGE-TSG","NG"),c("Novel DORGE-OG","CGC-TSG"),c("CGC-OG","Novel DORGE-TSG"));
ggboxplot(data = allgene2,x = "index", y="Cell_proliferation_rate",color="black",outlier.size = 0.2,width=0.7, fill="index",lwd=0.25,palette = c("#E41A1C","#377EB8","#CCCCCC","#4DAF4A","#984EA3"))+scale_x_discrete(labels=c("CGC-OG", "CGC-TSG", "NG", "Novel DORGE-OG", "Novel DORGE-TSG"))+scale_y_continuous(breaks = c(-2,-1,0,1,2),labels = c("-2", "-1", "0", "1", "2"))+ labs(x = "", y = "Cell proliferation rate change") + theme_bw() + theme(axis.ticks.x=element_blank(),axis.text.x = element_text(angle = 30, hjust = 1, colour = "black"),axis.text.y = element_text(angle = 90, hjust = 0.5, colour = "black"), panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(), axis.line = element_line(colour = "black"))+ guides(fill=FALSE)+stat_compare_means(aes(label = paste0(..p.format..)),method.args = list(alternative = "l"),comparisons = my_comparisons,size=2.5)
garbage <-dev.off()

######## Figure S4G Exoncons evaluation########
...
allgene2<-all_feature[all_feature$index!="",]
allgene2$index<-factor(allgene2$index,levels=c("CGC-OG", "CGC-TSG", "NG", "Novel DORGE-OG", "Novel DORGE-TSG"))
pdf("Raw_figures/Figure_S4G_phastcons_evaluation.pdf", family="ArialMT", width=2.275, height=3)
...
allgene2<-all_feature[all_feature$index!="",]
allgene2$index<-factor(allgene2$index,levels=c("CGC-OG", "CGC-TSG", "NG", "Novel DORGE-OG", "Novel DORGE-TSG"))
pdf("Raw_figures/Figure_3F_PhyloP_evaluation.pdf", family="ArialMT", width=2.275, height=3)
my_comparisons <- list(c("CGC-TSG","CGC-OG"),c("Novel DORGE-TSG","Novel DORGE-OG"),c("CGC-TSG","NG"),c("Novel DORGE-OG","NG"),c("CGC-OG","NG"),c("Novel DORGE-TSG","NG"),c("Novel DORGE-TSG","CGC-OG"),c("CGC-TSG","Novel DORGE-OG"));
...
allgene2<-all_feature[all_feature$index!="",]
allgene2$index<-factor(allgene2$index,levels=c("CGC-OG", "CGC-TSG", "NG", "Novel DORGE-OG", "Novel DORGE-TSG"))
pdf("Raw_figures/Figure_S4H_ncRVIS_evaluation.pdf", family="ArialMT", width=2.275, height=3)
my_comparisons <- list(c("CGC-OG","CGC-TSG"),c("Novel DORGE-OG","Novel DORGE-TSG"),c("CGC-TSG","NG"),c("Novel DORGE-OG","NG"),c("CGC-OG","NG"),c("Novel DORGE-TSG","NG"),c("Novel DORGE-OG","CGC-TSG"),c("CGC-OG","Novel DORGE-TSG"));
