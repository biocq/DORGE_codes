...
###### Output: Figure_2B_DORGE_TSG_cancermine_TSGene_venn.pdf: Venn diagram comparing DORGE TSG prediction with CancerMine and TSGene gene lists
###### Output: Figure_2C_DORGE_OG_cancermine_ONGene_venn.pdf: Venn diagram comparing DORGE OG prediction with ONGene gene list
...
output<-futile.logger::flog.threshold(futile.logger::ERROR, name = "VennDiagramLogger")
...
###### Figure 2B: DORGE-TSGs, Cancermine and TSGene ######
...
pdf(file="Raw_figures/Figure_2B_DORGE_TSG_cancermine_TSGene_venn.pdf", family="ArialMT", width=3, height=3)
    grid.draw(temp)
dev.off()


###### Figure 2C: DORGE-OGs, Cancermine and ONGene ######
...
pdf(file="Raw_figures/Figure_2C_DORGE_OG_cancermine_ONGene_venn.pdf", family="ArialMT", width=3, height=3)
    grid.draw(temp)
dev.off()