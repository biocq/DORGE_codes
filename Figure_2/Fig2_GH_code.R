...
###### Output: Figure_2G_qqplot_TSG_with_allfeature_specific_highlighted.pdf: QQplot for DORGE-TSG prediction
###### Output: Figure_2H_qqplot_OG_with_allfeature_specific_highlighted.pdf: QQplot for DORGE-OG prediction
...
pdf("Raw_figures/Figure_2G_qqplot_TSG_with_allfeature_specific_highlighted.pdf", family="ArialMT", width=3.9, height=2.7)
...
pdf("Raw_figures/Figure_2H_qqplot_OG_with_allfeature_specific_highlighted.pdf", family="ArialMT", width=3.9, height=2.7)
