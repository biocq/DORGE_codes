...
###### Output: Figure_2G_KEGG_novelTSGOG.pdf: KEGG pathway enrichment using Enrichr for DORGE-predict novel TSG/OGs predicted based on all features
###### Output: Figure_S3A_KEGG_non_epigenetics_features_novelTSGOG.pdf: KEGG pathway enrichment using Enrichr for DORGE-predict novel TSG/OGs predicted based on non-Epigenetics features only
###### Output: Figure_S3B_KEGG_correlation_TSG.pdf: Scatter plot comparing -log10(DORGE-TSG P-value) of KEGG pathway enrichment in Figure 2G and S3A
###### Output: Figure_S3C_KEGG_correlation_OG.pdf: Scatter plot comparing -log10(DORGE-OG P-value) of KEGG pathway enrichment in Figure 2G and S3A
...
pdf("Raw_figures/Figure_S3A_KEGG_non_epigenetics_features_novelTSGOG.pdf", family="ArialMT", width=6, height=11)#Figure 2F
