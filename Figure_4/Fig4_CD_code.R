...
###### Output: Figure_4C_BioGRID_network_hub_enrichment.pdf: PPI network hub gene enrichment in DORGE-predicted TSG/OGs, NGs and CGC genes
###### Output: Figure_4D_BioGRID_network_hub_enrichment.pdf: PPI network hub gene enrichment in functional genomics gene sets (or features)
...
######### Figure 4C and 4D: Gene enrichment in PPI network #########
...
pdf("Raw_figures/Figure_4C_BioGRID_network_hub_enrichment.pdf", family="ArialMT", width=4.19814*1.12, height=3.0)
...
pdf("Raw_figures/Figure_4D_BioGRID_network_hub_enrichment.pdf", family="ArialMT", width=5.2196*1.12, height=3)
