...
# Figure 4A is generated by Cytoscape
...
###### Output: Figure_4A_BioGRID_network_landscape.png: PPI landscape generated by Cytoscape


# Figure 4B is generated by Metascape (https://metascape.org/gp/index.html)
...
###### Output: Figure_4B_PPI_MCODE_modules.pdf: PPI modules generated by the Cytoscape session
...
##################### Figure 4A: PPI network node annotation generation #####################

#setwd("/Users/jlyu/Box\ Sync/TSGOG_Project/SA_sub/github/DORGE_paper/DORGE_codes/Figure_4");

##################### Statistical test related to Figure 4B: Statistical signficance calculation for dual function genes in the PPI network module #####################
