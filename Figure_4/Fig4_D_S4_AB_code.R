...
###### Output: Figure_S4B_survival_UCEC_evaluation.pdf: Evaluation of DORGE novel TSG/OGs by survival data in UCEC
...
ca<-paste("Raw_figures/Figure_S4A_survival_COAD_evaluation.pdf",sep="")
pdf(ca, family="ArialMT", width=2.275, height=3)
my_comparisons <- list(c("CGC-OG","CGC-TSG"),c("Novel DORGE-OG","Novel DORGE-TSG"),c("NG","CGC-TSG"),c("Novel DORGE-OG","NG"),c("CGC-OG","NG"),c("NG","Novel DORGE-TSG"),c("Novel DORGE-OG","CGC-TSG"),c("CGC-OG","Novel DORGE-TSG"));
...
ca<-paste("Raw_figures/Figure_S4B_survival_UCEC_evaluation.pdf",sep="")
pdf(ca, family="ArialMT", width=2.275, height=3)
my_comparisons <- list(c("CGC-OG","CGC-TSG"),c("Novel DORGE-OG","Novel DORGE-TSG"),c("NG","CGC-TSG"),c("Novel DORGE-OG","NG"),c("CGC-OG","NG"),c("NG","Novel DORGE-TSG"),c("Novel DORGE-OG","CGC-TSG"),c("CGC-OG","Novel DORGE-TSG"));
...
for(i in cancer_types){
	#ca<-paste("Raw_figures/Figure_S5A_oncolnc_",i,"_evaluation.pdf",sep="")
	#pdf(ca, family="ArialMT", width=2.275, height=3)
	#my_comparisons <- list(c("CGC-OG","CGC-TSG"),c("Novel DORGE-OG","Novel DORGE-TSG"),c("NG","CGC-TSG"),c("Novel DORGE-OG","NG"),c("CGC-OG","NG"),c("NG","Novel DORGE-TSG"),c("Novel DORGE-OG","CGC-TSG"),c("CGC-OG","Novel DORGE-TSG"));
